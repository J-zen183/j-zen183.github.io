...
function toTheme() {
    ...
    document.getElementById("jungleVehicle").hidden = true;
    document.getElementById("waterVehicle").hidden = true;
...
function start() {
  ...
  themePage = document.getElementById("chooseTheme");
...
function chooseV1() {
  ...
  document.getElementById("screen-content").style.background = "url('images/night.jpg')";
  document.getElementById("screen-content").style.backgroundSize = "120%";
...
function chooseV2() {
  ...
  document.getElementById("screen-content").style.background = "url('images/jungle.png')";
  document.getElementById("screen-content").style.backgroundSize = "120%";
...
function chooseV3() {
  ...
  document.getElementById("screen-content").style.background = "url('images/water.png')";
  document.getElementById("screen-content").style.backgroundSize = "110%";
...
function startGame(id) {
  ...
  page = document.getElementById("choice");
...
  scoreText = new component("50px", "'Fredoka One', cursive", colour,
  window.innerWidth/2 - 40, 150, 0, "text");
}
